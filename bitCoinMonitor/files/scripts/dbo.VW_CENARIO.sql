...
FROM	(
		...
		FROM	TB_CONSULTA C1 INNER JOIN TB_PARAMETROS P
					ON(1=1)		
		JOIN	TB_CONSULTA C2
					ON(C2.idt_consulta BETWEEN C1.idt_consulta-(P.qtd_registros_anterior-1) AND C1.idt_consulta)
